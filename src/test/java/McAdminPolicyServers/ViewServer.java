...
public class ViewServer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(20000);
		driver.findElement(By.xpath("//*[@id=\"apServers\"]")).click();
		driver.findElement(By.id("canSeeServers")).click();
		...
		System.out.println("Server visible   in the menu list  ");
	}
}
