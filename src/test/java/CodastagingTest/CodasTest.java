...
public class CodasTest {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		driver.findElement(By.xpath("//*[@id=\"name\"]")).sendKeys("Testing Files ");
		 ...
		 * 
		 * Robot rb = new Robot(); rb.delay(5000); StringSelection ssel = new
		 * StringSelection("C:\\Users\\CryptoMill\\Desktop\\image");
		 ...
		 * "//*[@id=\"messageList\"]/div[2]/article/div[1]/div/div/img")).click();
		 * Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[2]/article/div[2]/div[1]/i")).click();
		 * System.out.println("Sucessfully upload first file ............");
		 * Thread.sleep(5000); // ..............Second file..................//
		 * driver.findElement(By.id("addFiles")).click();
		 * 
		 * Robot rob = new Robot(); rob.delay(5000); Thread.sleep(10000);
		 * StringSelection ssl = new
		 * StringSelection("C:\\Users\\CryptoMill\\Desktop\\photo");
		 ...
		 * 
		 * rob.keyRelease(KeyEvent.VK_CONTROL); rob.keyRelease(KeyEvent.VK_V);
		 * 
		 ...
		 * Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[3]/article/div[1]/div/div/img")).click();
		 * Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[3]/article/div[2]/div[1]/i")).click();
		 * Thread.sleep(5000); // ..............Third file..................//
		 * driver.findElement(By.xpath("//*[@id=\"addFiles\"]")).click(); Robot robo =
		 * new Robot(); robo.delay(3000); StringSelection sl = new
		 * StringSelection("C:\\Users\\CryptoMill\\Desktop\\images");
		 ...
		 * xpath(" //*[@id=\"messageList\"]/div[4]/article/div[1]/div/div/img")).click()
		 * ; Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[4]/article/div[2]/div[1]/i")).click();
		 * Thread.sleep(5000); // ..............Fourth file..................//
		 * 
		 * driver.findElement(By.xpath("//*[@id=\"addFiles\"]")).click(); Robot rt = new
		 * Robot(); rt.delay(3000); StringSelection ss = new
		 * StringSelection("C:\\Users\\CryptoMill\\Desktop\\Abc");
		 * Toolkit.getDefaultToolkit().getSystemClipboard().setContents(ss, null);
		 * driver.findElement(By.xpath("//*[@id=\"button-addon2\"]")).click();
		 * 
		 * rt.keyPress(KeyEvent.VK_CONTROL); rt.keyPress(KeyEvent.VK_V);
		 * 
		 * rt.keyRelease(KeyEvent.VK_CONTROL); rt.keyRelease(KeyEvent.VK_V);
		 * 
		 * rt.keyPress(KeyEvent.VK_ENTER); rt.keyRelease(KeyEvent.VK_ENTER);
		 * Thread.sleep(5000);
		 * driver.findElement(By.xpath("//*[@id=\"button-addon2\"]")).click();
		 * System.out.println("Sucessfully upload forth  file ............");
		 * Thread.sleep(10000); driver.findElement(By.
		 * xpath(" //*[@id=\"messageList\"]/div[5]/article/div[1]/div/div/img")).click()
		 * ; Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[5]/article/div[2]/div[1]/i")).click();
		 * Thread.sleep(5000);
		 * 
		 * // ..............Fifth file..................//
		 * driver.findElement(By.xpath("//*[@id=\"addFiles\"]")).click(); Robot ro = new
		 * Robot(); ro.delay(3000); StringSelection s = new
		 * StringSelection("C:\\Users\\CryptoMill\\Desktop\\file.01");
		 * Toolkit.getDefaultToolkit().getSystemClipboard().setContents(s, null);
		 * 
		 * driver.findElement(By.xpath("//*[@id=\"button-addon2\"]")).click();
		 * 
		 * ro.keyPress(KeyEvent.VK_CONTROL); ro.keyPress(KeyEvent.VK_V);
		 * 
		 * ro.keyRelease(KeyEvent.VK_CONTROL); ro.keyRelease(KeyEvent.VK_V);
		 * 
		 * ro.keyPress(KeyEvent.VK_ENTER); ro.keyRelease(KeyEvent.VK_ENTER);
		 * 
		 * Thread.sleep(7000);
		 * driver.findElement(By.xpath("//*[@id=\"button-addon2\"]")).click();
		 * 
		 ...
		 * Thread.sleep(10000); driver.findElement(By.
		 * xpath(" //*[@id=\"messageList\"]/div[6]/article/div[1]/div/div/img")).click()
		 * ; Thread.sleep(10000); driver.findElement(By.xpath(
		 * "//*[@id=\"messageList\"]/div[6]/article/div[2]/div[1]/i")).click();
		 * Thread.sleep(5000);
		 */
		// ..............Sixth file..................//
		...
		Robot r = new Robot();
		r.delay(5000);
		StringSelection sli = new StringSelection("C:\\Users\\CryptoMill\\Desktop\\VideoFile");
		...
		Robot bo = new Robot();
		bo.delay(3000);
		StringSelection sle = new StringSelection("C:\\Users\\CryptoMill\\Desktop\\file02");
