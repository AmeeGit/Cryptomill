...
public class PromotePeople {
	...
	public static void main(String[] args)  throws InterruptedException {
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath("//*[@id=\"apPeople\"]")).click();

		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);

		driver.findElement(By.id("canPromotePeople")).click();
		driver.findElement(
		...
		driver.findElement(By.xpath("//*[@id=\"peopleCollection\"]/div[1]/p[2]")).click();
	}
}
