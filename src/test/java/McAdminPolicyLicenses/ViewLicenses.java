...
public class ViewLicenses {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath("//*[@id=\"apLicenses\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"canSeeLicenses\"]")).click();
		driver.findElement(
		...
		System.out.println("Licenses visible   in the menu list  ");
