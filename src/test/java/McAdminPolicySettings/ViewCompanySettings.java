...
public class ViewCompanySettings {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(20000);
		driver.findElement(By.xpath("//*[@id=\"apSettings\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"canSeeSettings\"]")).click();
		driver.findElement(
				By.xpath("//*[@id=\"popupContent\"]/div[2]/div[2]/div/div[2]/div[1]/form/fieldset/div[9]/button"))
				.click();
		System.out.println("Setting is visible / disable from the menu");
